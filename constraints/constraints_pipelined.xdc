...
create_generated_clock -name gated_clk_s1 \
    -source [get_pins u_cg_s1/clk] \
    -divide_by 1 \
    [get_pins u_cg_s1/gated_clk]

create_generated_clock -name gated_clk_s2 \
    -source [get_pins u_cg_s2/clk] \
    -divide_by 1 \
    [get_pins u_cg_s2/gated_clk]
